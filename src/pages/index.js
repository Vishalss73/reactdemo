...
const Home = () => {
  return (
   <div className='container'>
    <p className='top-description'>UI/UX  Refer & Earn </p>
    <div className='box-design'>
        ...
        <div className='right-box'>
            ...
            <p className='referral-code'>EDCH54</p>
            </div>
        </div>
...
<stop offset="1" stop-color="#FF864C"/>
    ...
    <div className='bottom-link'>
      <Link to="/page1">Friends Who Enrolled</Link>
      <Link to="/page2">Terms and Conditions</Link>
    </div>
   </div>
  )
}
